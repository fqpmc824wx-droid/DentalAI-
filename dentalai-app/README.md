...
> **Current status:** foundation scaffold with enterprise typed SQLite, staff lifecycle (S016), super-admin MFA, audit hardening (S017–S018), env separation/CSP/health (S019), backup evidence (S020), role navigation (S021), browser acceptance re-run (S022), schema foundation band (S023–S028), Dentally read-proof + data contracts (S029–S040), caller identity + authorisation band (S041–S057), queue taxonomy band (S087–S090), queue card fields (S091), human briefing (S092), Dentally link panel (S094), working tools (S095), SMS visibility (S096), callback tracker (S097), one-tap return call (S098), queue ownership band (S099–S102), close rule (S103), shift summaries (S107), same-patient banner (S105), duplicate caller (S106), and contact history (S109). Active roadmap in `../dentalai-planning-redesign.html`. **76 / 269** slices signed off. Not pilot-ready yet — out-of-hours (S113+), telephony, slot holds, and Dentally writes remain ahead.
...
- `npm run verify` passes: typecheck, lint, **432** Vitest tests across **40** files, and production build.
